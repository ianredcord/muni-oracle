...
export const ZH = {
  ...
  home: {
    ...
    whatIsMuni: {
      title: "MUNI 是什麼",
      body: "MUNI 是一種，\n讓身體重新感覺到安全與能量的方式。\n\n不是分析問題，\n也不是告訴你該變成怎樣。\n\n而是透過牌卡、香氣與簡單的身體覺察，\n讓神經系統慢慢放下防禦，\n情緒得以鬆動，\n意識回到當下。",
      bodyCore: "回到一個\n可以修復、可以流動、也能安心做自己的能量狀態。",
      bodySecondIntro: "很多時候，我們以為是自己不夠努力，\n其實是身體長時間處在緊繃、勉強運作的狀態裡。",
      bodySecondMiddle: "當內在的身心狀態感覺不到安全、\n也沒有多餘能量時，\n它只會維持生存，\n無法真正回到建設與修復。",
      bodySecondCore: "MUNI 的設計，\n不是要求你改變，\n而是先讓你回到\n「可以改變的狀態」。",
    },
